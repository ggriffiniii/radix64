...
pub const STD_ENCODE: &'static [u8; 64] = &[
    ...
    68,            // input   3 (0x03) => 'D' (0x44)
    69,            // input   4 (0x04) => 'E' (0x45)
    70,            // input   5 (0x05) => 'F' (0x46)
    71,            // input   6 (0x06) => 'G' (0x47)
    72,            // input   7 (0x07) => 'H' (0x48)
    73,            // input   8 (0x08) => 'I' (0x49)
    74,            // input   9 (0x09) => 'J' (0x4A)
    75,            // input  10 (0x0A) => 'K' (0x4B)
    76,            // input  11 (0x0B) => 'L' (0x4C)
    77,            // input  12 (0x0C) => 'M' (0x4D)
    78,            // input  13 (0x0D) => 'N' (0x4E)
    79,            // input  14 (0x0E) => 'O' (0x4F)
    80,            // input  15 (0x0F) => 'P' (0x50)
...
pub const STD_DECODE: &'static [u8; 256] = &[
    ...
    INVALID_VALUE, // input   3 (0x03)
    INVALID_VALUE, // input   4 (0x04)
    INVALID_VALUE, // input   5 (0x05)
    INVALID_VALUE, // input   6 (0x06)
    INVALID_VALUE, // input   7 (0x07)
    INVALID_VALUE, // input   8 (0x08)
    INVALID_VALUE, // input   9 (0x09)
    INVALID_VALUE, // input  10 (0x0A)
    INVALID_VALUE, // input  11 (0x0B)
    INVALID_VALUE, // input  12 (0x0C)
    INVALID_VALUE, // input  13 (0x0D)
    INVALID_VALUE, // input  14 (0x0E)
    INVALID_VALUE, // input  15 (0x0F)
    ...
    0,             // input  65 (0x41 char 'A') => 0   (0x00)
    1,             // input  66 (0x42 char 'B') => 1   (0x01)
    2,             // input  67 (0x43 char 'C') => 2   (0x02)
    3,             // input  68 (0x44 char 'D') => 3   (0x03)
    4,             // input  69 (0x45 char 'E') => 4   (0x04)
    5,             // input  70 (0x46 char 'F') => 5   (0x05)
    6,             // input  71 (0x47 char 'G') => 6   (0x06)
    7,             // input  72 (0x48 char 'H') => 7   (0x07)
    8,             // input  73 (0x49 char 'I') => 8   (0x08)
    9,             // input  74 (0x4A char 'J') => 9   (0x09)
    10,            // input  75 (0x4B char 'K') => 10  (0x0A)
    11,            // input  76 (0x4C char 'L') => 11  (0x0B)
    12,            // input  77 (0x4D char 'M') => 12  (0x0C)
    13,            // input  78 (0x4E char 'N') => 13  (0x0D)
    14,            // input  79 (0x4F char 'O') => 14  (0x0E)
    15,            // input  80 (0x50 char 'P') => 15  (0x0F)
...
pub const CRYPT_ENCODE: &'static [u8; 64] = &[
    ...
    49,            // input   3 (0x03) => '1' (0x31)
    50,            // input   4 (0x04) => '2' (0x32)
    51,            // input   5 (0x05) => '3' (0x33)
    52,            // input   6 (0x06) => '4' (0x34)
    53,            // input   7 (0x07) => '5' (0x35)
    54,            // input   8 (0x08) => '6' (0x36)
    55,            // input   9 (0x09) => '7' (0x37)
    56,            // input  10 (0x0A) => '8' (0x38)
    57,            // input  11 (0x0B) => '9' (0x39)
    65,            // input  12 (0x0C) => 'A' (0x41)
    66,            // input  13 (0x0D) => 'B' (0x42)
    67,            // input  14 (0x0E) => 'C' (0x43)
    68,            // input  15 (0x0F) => 'D' (0x44)
...
pub const CRYPT_DECODE: &'static [u8; 256] = &[
    ...
    INVALID_VALUE, // input  44 (0x2C)
    INVALID_VALUE, // input  45 (0x2D)
    0,             // input  46 (0x2E char '.') => 0   (0x00)
    1,             // input  47 (0x2F char '/') => 1   (0x01)
    2,             // input  48 (0x30 char '0') => 2   (0x02)
    3,             // input  49 (0x31 char '1') => 3   (0x03)
    4,             // input  50 (0x32 char '2') => 4   (0x04)
    5,             // input  51 (0x33 char '3') => 5   (0x05)
    6,             // input  52 (0x34 char '4') => 6   (0x06)
    7,             // input  53 (0x35 char '5') => 7   (0x07)
    8,             // input  54 (0x36 char '6') => 8   (0x08)
    9,             // input  55 (0x37 char '7') => 9   (0x09)
    10,            // input  56 (0x38 char '8') => 10  (0x0A)
    11,            // input  57 (0x39 char '9') => 11  (0x0B)
    INVALID_VALUE, // input  58 (0x3A)
    INVALID_VALUE, // input  59 (0x3B)
    INVALID_VALUE, // input  60 (0x3C)
    INVALID_VALUE, // input  61 (0x3D)
    ...
    INVALID_VALUE, // input  63 (0x3F)
    INVALID_VALUE, // input  64 (0x40)
    12,            // input  65 (0x41 char 'A') => 12  (0x0C)
    13,            // input  66 (0x42 char 'B') => 13  (0x0D)
    14,            // input  67 (0x43 char 'C') => 14  (0x0E)
    15,            // input  68 (0x44 char 'D') => 15  (0x0F)
...
pub const FAST_ENCODE: &'static [u8; 64] = &[
    ...
    65,            // input   3 (0x03) => 'A' (0x41)
    66,            // input   4 (0x04) => 'B' (0x42)
    67,            // input   5 (0x05) => 'C' (0x43)
    68,            // input   6 (0x06) => 'D' (0x44)
    69,            // input   7 (0x07) => 'E' (0x45)
    70,            // input   8 (0x08) => 'F' (0x46)
    71,            // input   9 (0x09) => 'G' (0x47)
    72,            // input  10 (0x0A) => 'H' (0x48)
    73,            // input  11 (0x0B) => 'I' (0x49)
    74,            // input  12 (0x0C) => 'J' (0x4A)
    75,            // input  13 (0x0D) => 'K' (0x4B)
    76,            // input  14 (0x0E) => 'L' (0x4C)
    77,            // input  15 (0x0F) => 'M' (0x4D)
    78,            // input  16 (0x10) => 'N' (0x4E)
    79,            // input  17 (0x11) => 'O' (0x4F)
    80,            // input  18 (0x12) => 'P' (0x50)
    81,            // input  19 (0x13) => 'Q' (0x51)
    82,            // input  20 (0x14) => 'R' (0x52)
    83,            // input  21 (0x15) => 'S' (0x53)
    84,            // input  22 (0x16) => 'T' (0x54)
    85,            // input  23 (0x17) => 'U' (0x55)
    86,            // input  24 (0x18) => 'V' (0x56)
    87,            // input  25 (0x19) => 'W' (0x57)
    88,            // input  26 (0x1A) => 'X' (0x58)
    89,            // input  27 (0x1B) => 'Y' (0x59)
    90,            // input  28 (0x1C) => 'Z' (0x5A)
    91,            // input  29 (0x1D) => '[' (0x5B)
    92,            // input  30 (0x1E) => '\' (0x5C)
    93,            // input  31 (0x1F) => ']' (0x5D)
    94,            // input  32 (0x20) => '^' (0x5E)
    95,            // input  33 (0x21) => '_' (0x5F)
    96,            // input  34 (0x22) => '`' (0x60)
    97,            // input  35 (0x23) => 'a' (0x61)
    98,            // input  36 (0x24) => 'b' (0x62)
    99,            // input  37 (0x25) => 'c' (0x63)
    100,           // input  38 (0x26) => 'd' (0x64)
    101,           // input  39 (0x27) => 'e' (0x65)
    102,           // input  40 (0x28) => 'f' (0x66)
    103,           // input  41 (0x29) => 'g' (0x67)
    104,           // input  42 (0x2A) => 'h' (0x68)
    105,           // input  43 (0x2B) => 'i' (0x69)
    106,           // input  44 (0x2C) => 'j' (0x6A)
    107,           // input  45 (0x2D) => 'k' (0x6B)
    108,           // input  46 (0x2E) => 'l' (0x6C)
    109,           // input  47 (0x2F) => 'm' (0x6D)
    110,           // input  48 (0x30) => 'n' (0x6E)
    111,           // input  49 (0x31) => 'o' (0x6F)
    112,           // input  50 (0x32) => 'p' (0x70)
    113,           // input  51 (0x33) => 'q' (0x71)
    114,           // input  52 (0x34) => 'r' (0x72)
    115,           // input  53 (0x35) => 's' (0x73)
    116,           // input  54 (0x36) => 't' (0x74)
    117,           // input  55 (0x37) => 'u' (0x75)
    118,           // input  56 (0x38) => 'v' (0x76)
    119,           // input  57 (0x39) => 'w' (0x77)
    120,           // input  58 (0x3A) => 'x' (0x78)
    121,           // input  59 (0x3B) => 'y' (0x79)
    122,           // input  60 (0x3C) => 'z' (0x7A)
    123,           // input  61 (0x3D) => '{' (0x7B)
...
pub const FAST_DECODE: &'static [u8; 256] = &[
    ...
    INVALID_VALUE, // input  49 (0x31)
    INVALID_VALUE, // input  50 (0x32)
    INVALID_VALUE, // input  51 (0x33)
    INVALID_VALUE, // input  52 (0x34)
    INVALID_VALUE, // input  53 (0x35)
    INVALID_VALUE, // input  54 (0x36)
    INVALID_VALUE, // input  55 (0x37)
    INVALID_VALUE, // input  56 (0x38)
    INVALID_VALUE, // input  57 (0x39)
    INVALID_VALUE, // input  58 (0x3A)
    INVALID_VALUE, // input  59 (0x3B)
    INVALID_VALUE, // input  60 (0x3C)
    INVALID_VALUE, // input  61 (0x3D)
    0,             // input  62 (0x3E char '>') => 0   (0x00)
    1,             // input  63 (0x3F char '?') => 1   (0x01)
    2,             // input  64 (0x40 char '@') => 2   (0x02)
    3,             // input  65 (0x41 char 'A') => 3   (0x03)
    4,             // input  66 (0x42 char 'B') => 4   (0x04)
    5,             // input  67 (0x43 char 'C') => 5   (0x05)
    6,             // input  68 (0x44 char 'D') => 6   (0x06)
    7,             // input  69 (0x45 char 'E') => 7   (0x07)
    8,             // input  70 (0x46 char 'F') => 8   (0x08)
    9,             // input  71 (0x47 char 'G') => 9   (0x09)
    10,            // input  72 (0x48 char 'H') => 10  (0x0A)
    11,            // input  73 (0x49 char 'I') => 11  (0x0B)
    12,            // input  74 (0x4A char 'J') => 12  (0x0C)
    13,            // input  75 (0x4B char 'K') => 13  (0x0D)
    14,            // input  76 (0x4C char 'L') => 14  (0x0E)
    15,            // input  77 (0x4D char 'M') => 15  (0x0F)
    16,            // input  78 (0x4E char 'N') => 16  (0x10)
    17,            // input  79 (0x4F char 'O') => 17  (0x11)
    18,            // input  80 (0x50 char 'P') => 18  (0x12)
    19,            // input  81 (0x51 char 'Q') => 19  (0x13)
    20,            // input  82 (0x52 char 'R') => 20  (0x14)
    21,            // input  83 (0x53 char 'S') => 21  (0x15)
    22,            // input  84 (0x54 char 'T') => 22  (0x16)
    23,            // input  85 (0x55 char 'U') => 23  (0x17)
    24,            // input  86 (0x56 char 'V') => 24  (0x18)
    25,            // input  87 (0x57 char 'W') => 25  (0x19)
    26,            // input  88 (0x58 char 'X') => 26  (0x1A)
    27,            // input  89 (0x59 char 'Y') => 27  (0x1B)
    28,            // input  90 (0x5A char 'Z') => 28  (0x1C)
    29,            // input  91 (0x5B char '[') => 29  (0x1D)
    30,            // input  92 (0x5C char '\') => 30  (0x1E)
    31,            // input  93 (0x5D char ']') => 31  (0x1F)
    32,            // input  94 (0x5E char '^') => 32  (0x20)
    33,            // input  95 (0x5F char '_') => 33  (0x21)
    34,            // input  96 (0x60 char '`') => 34  (0x22)
    35,            // input  97 (0x61 char 'a') => 35  (0x23)
    36,            // input  98 (0x62 char 'b') => 36  (0x24)
    37,            // input  99 (0x63 char 'c') => 37  (0x25)
    38,            // input 100 (0x64 char 'd') => 38  (0x26)
    39,            // input 101 (0x65 char 'e') => 39  (0x27)
    40,            // input 102 (0x66 char 'f') => 40  (0x28)
    41,            // input 103 (0x67 char 'g') => 41  (0x29)
    42,            // input 104 (0x68 char 'h') => 42  (0x2A)
    43,            // input 105 (0x69 char 'i') => 43  (0x2B)
    44,            // input 106 (0x6A char 'j') => 44  (0x2C)
    45,            // input 107 (0x6B char 'k') => 45  (0x2D)
    46,            // input 108 (0x6C char 'l') => 46  (0x2E)
    47,            // input 109 (0x6D char 'm') => 47  (0x2F)
    48,            // input 110 (0x6E char 'n') => 48  (0x30)
    49,            // input 111 (0x6F char 'o') => 49  (0x31)
    50,            // input 112 (0x70 char 'p') => 50  (0x32)
    51,            // input 113 (0x71 char 'q') => 51  (0x33)
    52,            // input 114 (0x72 char 'r') => 52  (0x34)
    53,            // input 115 (0x73 char 's') => 53  (0x35)
    54,            // input 116 (0x74 char 't') => 54  (0x36)
    55,            // input 117 (0x75 char 'u') => 55  (0x37)
    56,            // input 118 (0x76 char 'v') => 56  (0x38)
    57,            // input 119 (0x77 char 'w') => 57  (0x39)
    58,            // input 120 (0x78 char 'x') => 58  (0x3A)
    59,            // input 121 (0x79 char 'y') => 59  (0x3B)
    60,            // input 122 (0x7A char 'z') => 60  (0x3C)
    61,            // input 123 (0x7B char '{') => 61  (0x3D)
    62,            // input 124 (0x7C char '|') => 62  (0x3E)
    63,            // input 125 (0x7D char '}') => 63  (0x3F)
    INVALID_VALUE, // input 126 (0x7E)
    INVALID_VALUE, // input 127 (0x7F)
    INVALID_VALUE, // input 128 (0x80)
    INVALID_VALUE, // input 129 (0x81)
